...
import type { HamperLead as _HamperLead, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllLeads(): Promise<Array<HamperLead>> {
        if (this.processError) {
            try {
    ...
    async submitHamperLead(arg0: HamperLead): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitHamperLead(to_candid_HamperLead_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_HamperLead_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _HamperLead): HamperLead {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        preferredItems: value.preferredItems,
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_HamperLead>): Array<HamperLead> {
    return value.map((x)=>from_candid_HamperLead_n4(_uploadFile, _downloadFile, x));
}
function to_candid_HamperLead_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: HamperLead): _HamperLead {
